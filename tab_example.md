...
For full details, including slides and videos of sessions, go to the main [EUTour2013 Page](https://www.owasp.org/index.php/EUTour2013) and click through to the London event.
...
-   *Implementing cryptography: good theory vs. bad practice - Viet Pham ([PDF](https://www.owasp.org/images/c/c5/OwaspTalkMarch.pdf))*
...
-   *Securing the SSL channel against man-in-the-middle attacks: Future technologies - HTTP Strict Transport Security and and Pinning of Certs - Tobias Gondrom ([PDF](http://www.gondrom.org/owasp/presentations/OWASP_defending-MITMA_RHUL.pdf))*
...
**Speaker**: Daniel Cuthbert ([deck](http://prezi.com/ylfkkek0vb-r/all-aboard-the-lulz-boat/))
...
A special meeting event, in conjunction with [London Geek Nights](http://londongeeknights.wetpaint.com) on SSL usage and dangers. An opportunity to get some of the developer and security communities together to talk more pragmatically on this very key topic.
